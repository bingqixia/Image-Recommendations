...
class Itemimages(db.Model):
    itemId = db.Column(db.String(150), primary_key=True)
    catId = db.Column(db.String(150), unique=False, nullable=False)
...
class UserStar(db.Model):
    ...
    itemId = db.Column(db.String(150), primary_key=True, unique=False, nullable=False)
...
class Imagerecommendations(db.Model): 
    itemId = db.Column(db.String(150), primary_key=True)
    recommendedId = db.Column(db.String(150), db.ForeignKey('galleryimages.itemId'), nullable=False)
